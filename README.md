...
```sh
# Check Claude Code Plugins Status
claude plugin list
# - ralph-skills@ralph-marketplace  Status: ✔ enabled
# - superpowers@claude-plugins-official Status: ✔ enabled
```
...
## Harness-Engineering Project Directory Structure Example
